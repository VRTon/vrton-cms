...
export function createAdminApiPlugin() {
  return {
    ...
    configureServer(server) {
      ...
      server.middlewares.use('/__admin/api/hot-reload', async (req, res) => {
        setCors(res);
        ...
        try {
          ...
          sendJson(res, 500, { error: error.message || 'Unable to trigger reload' });
        }
      });
    },
  };
